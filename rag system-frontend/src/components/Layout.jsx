        ...
        <div className="px-5 py-5 border-b border-ink-800/60">
          <div className="flex items-center gap-2.5">
            <div className="w-7 h-7 rounded-lg bg-amber-400 flex items-center justify-center">
              <span className="text-ink-950 text-xs font-bold font-mono">
                R
              </span>
            </div>
            <span className="font-display font-700 text-ink-100 tracking-tight">
              RAG
            </span>
            <span className="font-display text-ink-500 text-xs tracking-widest uppercase">
              System
            </span>
          </div>
        </div>
